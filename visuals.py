...
def get_bloch_coordinates(qc):
    """
    Extract Bloch sphere coordinates [x, y, z] from a quantum circuit.
    """
    sv = Statevector.from_instruction(qc)
    # Expectation values of Pauli operators give the Bloch coordinates
    # For a single qubit state rho: rho = 1/2 (I + xX + yY + zZ)
