    ...
    if st.button("Run Simulation"):
        ...
        if eve_present:
            if attack_choice == "Intercept-Resend":
                # Use noise_level as intercept_probability
                attack = InterceptResend(intercept_probability=noise_level)
        ...
        for i in range(min(3, n)):
            ...
            with col_c2:
                # Visualize the state as it arrives at Bob, before his measurement
