...
from core import BB84Protocol, B92Protocol, SimulationEngine, InterceptResend, NoisyChannel, PhotonNumberSplitting, calculate_qber, analyze_security, generate_error_report
...
with tab1:
    ...
    if st.button("Run Simulation"):
        ...
        with st.status(f"Running {protocol_choice} simulation...", expanded=True) as status:
        ...
        viz_data = {
            ...
            "encoded_qubits": results['circuits']
        }
