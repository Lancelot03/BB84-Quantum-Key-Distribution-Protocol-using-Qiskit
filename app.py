    ...
    if st.button("Run Simulation"):
        ...
        for i in range(min(3, n)):
            ...
            with col_c2:
                ...
                # Visualize the received state (after attack but before measurement basis transformation)
...
with tab2:
    ...
    with visual_tab:
        ...
        # Track eve_present from the simulation tab or allow interactive toggle in visual learning
        eve_learning = st.toggle("Show Eve in animation", value=False)
