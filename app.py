...
with tab1:
    ...
    if st.button("Run Simulation"):
        ...
        # Alice bases for B92 display
        display_alice_bases = alice_bases if protocol_choice == "BB84" else ["B92"] * n
        report = generate_error_report(alice_bits, bob_results, display_alice_bases, bob_bases, key_a, key_b)

        # For visualization
        viz_data = {
            "alice_bits": alice_bits,
            "alice_bases": display_alice_bases,
            "bob_bases": bob_bases,
        ...
        if viz_data['report']:
            ...
            if protocol_choice == "BB84":
                ...
                col2.metric("Sifted Key Length", f"{len(key_a)}")
